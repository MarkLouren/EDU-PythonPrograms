#classes coins.py [Methods], Polymorphism
import random

class Coin:
    #kwargs-get possibility to accept more arguments
    def __init__(self, rare=False, clean =True, heads=True, **kwargs):

        for key,value in kwargs.items():
            setattr(self,key,value) #set attributes self.key=value, ex: self.mass=9.5
    ...
    def flip(self):
        ...
        self.heads=choice
#_str_ defines what we show when we print the object
    def __str__(self):
...
class Fifty_Pence(Coin):
    ...
    #class Pound inherit from the class Coin
class One_Pound (Coin):
    def __init__(self):
        ...
        # super class the same as a parent class
        super().__init__(**data)
